...
pub fn normalize_assignment_for_target(target: &Value, value: Value) -> Value {
    match (target, value) {
        ...
        (Value::Int(_), Value::SInt(value)) => Value::Int(i16::from(value)),
        (Value::DInt(_), Value::SInt(value)) => Value::DInt(i32::from(value)),
        (Value::DInt(_), Value::Int(value)) => Value::DInt(i32::from(value)),
        (Value::LInt(_), Value::SInt(value)) => Value::LInt(i64::from(value)),
        (Value::LInt(_), Value::Int(value)) => Value::LInt(i64::from(value)),
        (Value::LInt(_), Value::DInt(value)) => Value::LInt(i64::from(value)),
        (Value::UInt(_), Value::USInt(value)) => Value::UInt(u16::from(value)),
        (Value::UDInt(_), Value::USInt(value)) => Value::UDInt(u32::from(value)),
        (Value::UDInt(_), Value::UInt(value)) => Value::UDInt(u32::from(value)),
        (Value::ULInt(_), Value::USInt(value)) => Value::ULInt(u64::from(value)),
        (Value::ULInt(_), Value::UInt(value)) => Value::ULInt(u64::from(value)),
        (Value::ULInt(_), Value::UDInt(value)) => Value::ULInt(u64::from(value)),
        (Value::Real(_), Value::SInt(value)) => Value::Real(f32::from(value)),
        (Value::Real(_), Value::Int(value)) => Value::Real(f32::from(value)),
        (Value::Real(_), Value::DInt(value)) => Value::Real(value as f32),
        (Value::LReal(_), Value::SInt(value)) => Value::LReal(f64::from(value)),
        (Value::LReal(_), Value::Int(value)) => Value::LReal(f64::from(value)),
        (Value::LReal(_), Value::DInt(value)) => Value::LReal(f64::from(value)),
        (Value::LReal(_), Value::LInt(value)) => Value::LReal(value as f64),
        (Value::LReal(_), Value::Real(value)) => Value::LReal(f64::from(value)),
        (Value::Word(_), Value::Byte(value)) => Value::Word(u16::from(value)),
        (Value::DWord(_), Value::Byte(value)) => Value::DWord(u32::from(value)),
        (Value::DWord(_), Value::Word(value)) => Value::DWord(u32::from(value)),
        (Value::LWord(_), Value::Byte(value)) => Value::LWord(u64::from(value)),
        (Value::LWord(_), Value::Word(value)) => Value::LWord(u64::from(value)),
        (Value::LWord(_), Value::DWord(value)) => Value::LWord(u64::from(value)),
        (_, value) => value,
    }
}
