...
- scalar math helpers plus the current geometry and double-precision slices: `CIRCLE_A`, `CIRCLE_C`, `CIRCLE_SEG`, `CONE_V`, `ELLIPSE_A`, `ELLIPSE_C`, `SPHERE_V`, `TRIANGLE_A`, and `REAL2` helpers `R2_SET`, `R2_ABS`, `R2_ADD`, `R2_ADD2`, `R2_MUL`
