...
- scalar math helpers plus the current linear/polynomial/ramp, geometry, stateful averaging, and double-precision slices: `F_LIN`, `F_LIN2`, `F_POLY`, `F_POWER`, `F_QUAD`, `FRMP_B`, `FT_AVG`, `CIRCLE_A`, `CIRCLE_C`, `CIRCLE_SEG`, `CONE_V`, `ELLIPSE_A`, `ELLIPSE_C`, `SPHERE_V`, `TRIANGLE_A`, and `REAL2` helpers `R2_SET`, `R2_ABS`, `R2_ADD`, `R2_ADD2`, `R2_MUL`
