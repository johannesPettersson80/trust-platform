...
| `argument_count_resource_limit` | Argument-count resource limit | `required` | `SPEC_BYTECODE_FORMAT_001#fixed-resource-limits` |
| `bad_magic` | Bad bytecode magic | `required` | `SPEC_BYTECODE_FORMAT_001` |
| `call_depth_resource_limit` | Call-depth resource limit | `required` | `SPEC_BYTECODE_FORMAT_001#fixed-resource-limits` |
...
| `locals_resource_limit` | Locals resource limit | `required` | `SPEC_BYTECODE_FORMAT_001#fixed-resource-limits` |
...
| `refs_resource_limit` | Reference-count resource limit | `required` | `SPEC_BYTECODE_FORMAT_001#fixed-resource-limits` |
