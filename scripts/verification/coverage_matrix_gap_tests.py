...
class CoverageMatrixGapTests(unittest.TestCase):
    ...
    def test_current_repository_baseline_counts_and_input_closure(self) -> None:
        ...
        self.assertEqual(
            ...
            {
                "mapped_areas": 11,
                "mapped_area_invariants": 69,
                "out_of_scope_invariants": 0,
                "required_family_slots": 90,
                "assigned_required_slots": 18,
                "missing_required_slots": 72,
                "additional_recorded_cells": 72,
                "recorded_cells": 90,
                "case_files": 7,
                "case_observations": 38,
                "blocked_case_observations": 0,
                "state_counts": empty_state_counts(spec_gap=0, gap_open=21, covered=69),
            },
        )
