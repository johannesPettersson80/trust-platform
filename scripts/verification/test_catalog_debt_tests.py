...
class UnmappedTestDebtTests(unittest.TestCase):
    ...
    def test_live_repository_baseline_lists_all_3817_unmapped_identities(self) -> None:
        ...
        self.assertEqual(analysis["summary"]["scanner_facts"], 3818)
        self.assertEqual(analysis["summary"]["mapped_scanner_facts"], 1)
        self.assertEqual(analysis["summary"]["unmapped_scanner_facts"], 3817)
        self.assertEqual(len(analysis["unmapped_tests"]), 3817)
        self.assertEqual(
