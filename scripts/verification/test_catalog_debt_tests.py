...
class UnmappedTestDebtTests(unittest.TestCase):
    ...
    def test_live_repository_baseline_lists_all_unmapped_identities(self) -> None:
        ...
        self.assertEqual(analysis["summary"]["scanner_facts"], 3899)
        self.assertEqual(analysis["summary"]["mapped_scanner_facts"], 102)
        self.assertEqual(analysis["summary"]["unmapped_scanner_facts"], 3797)
        self.assertEqual(len(analysis["unmapped_tests"]), 3797)
        self.assertEqual(
