...
REVIEWED_EXECUTION_FILE_DIGESTS = {
    ...
    ".github/workflows/ci.yml": "b3383218c5e4b07055b5b4b6b32abc242f8c264774b969898559b70d08158249",
...
REVIEWED_WORKFLOW_JOB_DIGESTS = {
    ...
    (".github/workflows/ci.yml", "conformance"): (
        "687db5f20cd1eef8f6e6cecc1b923a23c5ec5e14b92d9d1c3e90b4cfdf4ac96f"
    ),
