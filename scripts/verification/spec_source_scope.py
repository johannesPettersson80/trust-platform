...
OBVIOUS_SPEC_TOPICS = (
    ...
    ObviousSpecTopic("P1A004_LSP_SYNC_POSITIONS_CANCELLATION", "LSP sync/positions/cancellation", "gap_open", ("SPEC_LSP_CONTRACT_001",), open_spec_gap_ids=("SPEC_GAP_EDITOR_LSP_POSITION_ENCODING_001",), areas=("editor_safety",)),
