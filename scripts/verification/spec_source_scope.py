...
OBVIOUS_SPEC_TOPICS = (
    ...
    ObviousSpecTopic("P1A004_HMI_API_UI", "HMI API/UI", "source_present", ("SPEC_CONNECTOR_STATUS_001", "SPEC_RUNTIME_ENGINE_001"), public_claim_context_ids=("PUBLIC_CLAIM_RUNTIME_WIRE_001",), areas=("control_security", "hmi_ui")),
