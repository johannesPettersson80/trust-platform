...
OBVIOUS_SPEC_TOPICS = (
    ...
    ObviousSpecTopic("P1A004_STOP_SAFE_STATE", "stop/safe-state", "gap_open", ("SPEC_RUNTIME_ENGINE_001", "SPEC_RUNTIME_SAFETY_FAIL_CLOSED_BOARD_001"), open_spec_gap_ids=("SPEC_GAP_RUNTIME_SAFE_STATE_001",), areas=("runtime_safety",)),
    ObviousSpecTopic("P1A004_RETAIN_RESTART", "retain/restart", "gap_open", ("SPEC_IEC_DECISIONS_001", "SPEC_RUNTIME_ENGINE_001", "SPEC_RUNTIME_SAFETY_FAIL_CLOSED_BOARD_001", "SPEC_RUNTIME_SEMANTICS_001"), open_spec_gap_ids=("SPEC_GAP_RUNTIME_RETAIN_FAILURE_001",), areas=("runtime_safety",)),
    ObviousSpecTopic("P1A004_PROTOCOL_STATUS_DISCOVERY", "protocol status/discovery", "gap_open_partial", ("SPEC_OPCUA_CLIENT_LIFECYCLE_DECISION_001",), open_spec_gap_ids=("SPEC_GAP_PROTOCOL_DISCOVERY_HANDSHAKE_001", "SPEC_GAP_PROTOCOL_STATUS_MODEL_001"), public_claim_context_ids=("PUBLIC_CLAIM_RUNTIME_WIRE_001",), areas=("protocols",)),
    ObviousSpecTopic("P1A004_HMI_API_UI", "HMI API/UI", "gap_open_partial", ("SPEC_RUNTIME_ENGINE_001",), open_spec_gap_ids=("SPEC_GAP_CONTROL_AUTHORIZATION_MATRIX_001", "SPEC_GAP_UI_STATUS_VOCABULARY_001"), public_claim_context_ids=("PUBLIC_CLAIM_RUNTIME_WIRE_001",), areas=("control_security", "hmi_ui")),
    ObviousSpecTopic("P1A004_SOURCE_TRANSFORMATIONS", "source transformations", "gap_open", ("SPEC_BYTECODE_FORMAT_001", "SPEC_RUNTIME_SEMANTICS_001"), open_spec_gap_ids=("SPEC_GAP_VM_LOWERING_FAIL_CLOSED_001",), areas=("bytecode_vm",)),
    ObviousSpecTopic("P1A004_LSP_SYNC_POSITIONS_CANCELLATION", "LSP sync/positions/cancellation", "gap_open", ("SPEC_LSP_CONTRACT_001",), open_spec_gap_ids=("SPEC_GAP_EDITOR_DIAGNOSTIC_CANCELLATION_001", "SPEC_GAP_EDITOR_LSP_POSITION_ENCODING_001"), areas=("editor_safety",)),
    ObviousSpecTopic("P1A004_DEBUG_DAP_FORCE_WRITE_RELEASE_LIFECYCLE", "debug/DAP force-write-release lifecycle", "gap_open", ("SPEC_DEBUG_ADAPTER_001", "SPEC_RUNTIME_ENGINE_001"), open_spec_gap_ids=("SPEC_GAP_RUNTIME_FORCE_LIFECYCLE_001",), areas=("control_security", "editor_safety", "runtime_safety")),
    ObviousSpecTopic("P1A004_CONTROL_RBAC_SECURITY", "control/RBAC/security", "gap_open", ("SPEC_DEBUG_ADAPTER_001", "SPEC_RUNTIME_ENGINE_001"), open_spec_gap_ids=("SPEC_GAP_CONTROL_AUTHORIZATION_MATRIX_001", "SPEC_GAP_DEBUG_AUTHORIZATION_001"), areas=("control_security",)),
    ...
    ObviousSpecTopic("P1A004_CLI_CONTROL_SOCKET_SURFACES", "CLI and control-socket surfaces", "partial_gap_no_source", open_spec_gap_ids=("SPEC_GAP_CONTROL_AUTHORIZATION_MATRIX_001",), areas=("control_security", "runtime_safety")),
