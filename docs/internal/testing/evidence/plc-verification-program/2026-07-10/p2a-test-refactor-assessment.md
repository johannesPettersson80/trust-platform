...
Generated JSON SHA-256: `837e2f14c9a43f5d60290f6d4acfdddde7fb532f6135158ccc3fd032a900c36f`
Input SHA-256: `sha256:bf56629f05152a096632070c4360e200b64868f00c4e44b930e657f5429fd467`
...
| `crates/trust-runtime/tests/bytecode_decode_resource_bounds.rs` | 317 | 8 | 7 | `reviewed_mapping_diversity` |
...
- `TEST_CONFORMANCE_ARITHMETIC_CONVERSION_COMPARE_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_ARITHMETIC_OVERFLOW_002` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_ARRAY_MATRIX_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_COMMS_PROJECTION_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_EDGE_SEQUENCE_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_ENUM_ASSIGNMENT_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_RETAIN_RESTART_002` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_INITIALIZATION_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_MEMORY_MAP_SYNC_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_MEMORY_MAP_WILDCARD_002` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_NESTED_VALUES_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_OOP_DISPATCH_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_REFERENCE_WRITE_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_RETAIN_MATRIX_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_SCAN_CYCLE_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_SCHEDULER_INTERVAL_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_STRING_SLICE_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_STRUCT_UPDATE_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_TIMER_TOF_002` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_TIMER_TON_001` claims 1 invariants; result `single_invariant`.
- `TEST_CONFORMANCE_TIMER_TP_003` claims 1 invariants; result `single_invariant`.
...
- `TEST_DEV_COMMIT_SCOPE_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_REVIEW_COMMIT_SCOPE_CONTAINMENT_001` claims 1 invariants; result `single_invariant`.
- `TEST_REVIEW_COMMIT_SCOPE_RACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_DEV_TEST_DISCOVERY_TRACE_001` claims 1 invariants; result `single_invariant`.
...
- `TEST_REVIEW_FIELD_RENAME_CROSS_FILE_001` claims 1 invariants; result `single_invariant`.
...
- `TEST_REVIEW_LSP_INVALID_CHANGE_RANGE_001` claims 1 invariants; result `single_invariant`.
...
- `TEST_REVIEW_DIDCLOSE_CACHE_RACE_001` claims 1 invariants; result `single_invariant`.
...
- `TEST_REVIEW_OPCUA_SNAPSHOT_READ_ONLY_001` claims 1 invariants; result `single_invariant`.
...
- `TEST_UI_CONNECTOR_STATUS_TRACE_001` claims 1 invariants; result `single_invariant`.
...
- `TEST_REVIEW_WATCHDOG_PARTIAL_SAFE_STATE_001` claims 1 invariants; result `single_invariant`.
...
- `TEST_REVIEW_INTERNAL_NONFINITE_CONVERSION_001` claims 1 invariants; result `single_invariant`.
...
- `TEST_REVIEW_SIM_CLOCK_OVERFLOW_001` claims 1 invariants; result `single_invariant`.
...
- `TEST_ARTIFACT_PROVENANCE_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_DEBUG_BEHAVIOR_LOCK_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_DEPENDENCY_EXCEPTION_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_PLATFORM_PATH_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_RELEASE_CONFORMANCE_STATUS_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_RELEASE_HARDWARE_CLAIM_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_RELEASE_PLATFORM_MATRIX_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_RELEASE_SOURCE_BUILD_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_RELEASE_VERSION_CHAIN_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_RUNTIME_BEHAVIOR_LOCK_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_VSIX_TARGET_IDENTITY_TRACE_001` claims 1 invariants; result `single_invariant`.
- `TEST_REVIEW_PEER_CONFIDENCE_REJECTION_001` claims 1 invariants; result `single_invariant`.
- `TEST_REVIEW_PEER_TOPOLOGY_VISIBLE_FAILURE_001` claims 1 invariants; result `single_invariant`.
- `TEST_REVIEW_PEER_TOPOLOGY_ERROR_RENDER_001` claims 1 invariants; result `single_invariant`.
...
- Structural peers in `verification/cases/hmi_ui/UI_STATUS_001.toml`: `UI_STATUS_001_CANONICAL_STATUS_VOCABULARY`, `UI_STATUS_001_FRESHNESS_AND_DETAIL_PRESERVATION`, `UI_STATUS_001_UNKNOWN_STATUS_IDENTIFIER`; shape `sha256:5583f769954ed3a1265abd03edaee615985ac4cd8dffbd88b1b246bdc76df8e2`.
- Structural peers in `verification/cases/plcopen_devtools/DEV_COMMIT_SCOPE_001.toml`: `DEV_COMMIT_SCOPE_001_DRY_RUN_OR_CANCEL`, `DEV_COMMIT_SCOPE_001_PRESTAGED_OUTSIDE_SCOPE`, `DEV_COMMIT_SCOPE_001_PRESTAGED_SCOPE_COLLISION`; shape `sha256:5583f769954ed3a1265abd03edaee615985ac4cd8dffbd88b1b246bdc76df8e2`.
- Structural peers in `verification/cases/plcopen_devtools/DEV_TEST_DISCOVERY_001.toml`: `DEV_TEST_DISCOVERY_001_SUPPORTED_EXTENSION_CASES`, `DEV_TEST_DISCOVERY_001_UNSUPPORTED_OR_EMPTY_DISCOVERY`; shape `sha256:5583f769954ed3a1265abd03edaee615985ac4cd8dffbd88b1b246bdc76df8e2`.
...
- Scanner `DISC_0145FBD6A5391DCD3D08` / `TEST_RELEASE_SOURCE_BUILD_TRACE_001`: `fast` at `crates/verification-cases/tests/release_evidence_trace_cases.rs`.
...
- Scanner `DISC_0BFFF05426BC5C26AA8F` / `TEST_CONFORMANCE_OOP_DISPATCH_001`: `fast` at `conformance/cases/oop_dispatch/cfm_oop_dispatch_interface_super_001/manifest.toml`.
...
- Scanner `DISC_1637A1817C92DAA0D6D9` / `TEST_DEV_TEST_DISCOVERY_TRACE_001`: `fast` at `crates/trust-dev/src/test_cmd/tests.rs`.
...
- Scanner `DISC_182D903DB2459EFDA719` / `TEST_ARTIFACT_PROVENANCE_TRACE_001`: `fast` at `crates/verification-cases/tests/release_evidence_trace_cases.rs`.
...
- Scanner `DISC_1A7D8ACCA29EBED677D5` / `TEST_REVIEW_PEER_TOPOLOGY_VISIBLE_FAILURE_001`: `fast` at `editors/vscode/src/test/suite/connector-status-contract.test.ts`.
...
- Scanner `DISC_1B43538537AE7BF78773` / `TEST_CONFORMANCE_STRING_SLICE_001`: `fast` at `conformance/cases/strings/cfm_strings_slice_concat_001/manifest.toml`.
...
- Scanner `DISC_1B9D15A301C7C51836EE` / `TEST_REVIEW_PEER_CONFIDENCE_REJECTION_001`: `fast` at `editors/vscode/src/test/suite/connector-status-contract.test.ts`.
...
- Scanner `DISC_1C8A59E3B5624A561BBB` / `TEST_RELEASE_VERSION_CHAIN_TRACE_001`: `fast` at `crates/verification-cases/tests/release_evidence_trace_cases.rs`.
...
- Scanner `DISC_1E8E70783D84A9713502` / `TEST_CONFORMANCE_TIMER_TP_003`: `fast` at `conformance/cases/timers/cfm_timers_tp_sequence_003/manifest.toml`.
...
- Scanner `DISC_291B55D1A946A33DD891` / `TEST_CONFORMANCE_NESTED_VALUES_001`: `fast` at `conformance/cases/nested_values/cfm_nested_values_matrix_struct_001/manifest.toml`.
- Scanner `DISC_2A4BDACD2DFE7087A51C` / `TEST_IEC_SUBRANGE_TRACE_001`: `fast` at `crates/trust-hir/tests/subrange_trace_cases.rs`.
- Scanner `DISC_2B1117F165B0C1537F1C` / `TEST_REVIEW_LSP_INVALID_CHANGE_RANGE_001`: `fast` at `crates/trust-lsp/src/handlers/sync.rs`.
...
- Scanner `DISC_33DB836D6699F5BF85EF` / `TEST_DEBUG_BEHAVIOR_LOCK_TRACE_001`: `fast` at `crates/verification-cases/tests/release_evidence_trace_cases.rs`.
- Scanner `DISC_33E5D40504EBC4C32030` / `TEST_REVIEW_SIM_CLOCK_OVERFLOW_001`: `fast` at `crates/trust-runtime/tests/tasks.rs`.
...
- Scanner `DISC_402CC44CEBE7D8B978DD` / `TEST_CONFORMANCE_RETAIN_MATRIX_001`: `fast` at `conformance/cases/retain_matrix/cfm_retain_matrix_restart_aliases_001/manifest.toml`.
...
- Scanner `DISC_4E9D9B0475D911439261` / `TEST_CONFORMANCE_MEMORY_MAP_SYNC_001`: `fast` at `conformance/cases/memory_map/cfm_memory_map_var_config_sync_001/manifest.toml`.
...
- Scanner `DISC_588B8448FA2B76D38A8A` / `TEST_RUNTIME_BEHAVIOR_LOCK_TRACE_001`: `fast` at `crates/verification-cases/tests/release_evidence_trace_cases.rs`.
- Scanner `DISC_5B6112AAFB09A8DF21E2` / `TEST_REVIEW_OPCUA_SNAPSHOT_READ_ONLY_001`: `fast` at `crates/trust-runtime/tests/opcua_integration.rs`.
- Scanner `DISC_5C3DF358E2A0ED1731A0` / `TEST_PLATFORM_PATH_TRACE_001`: `fast` at `crates/verification-cases/tests/release_evidence_trace_cases.rs`.
...
- Scanner `DISC_7164799F8FC7FF30F098` / `TEST_CONFORMANCE_SCHEDULER_INTERVAL_001`: `fast` at `conformance/cases/scheduler/cfm_scheduler_task_interval_001/manifest.toml`.
...
- Scanner `DISC_8194B9D99740A75BF56A` / `TEST_REVIEW_COMMIT_SCOPE_RACE_001`: `fast` at `crates/trust-dev/src/commit.rs`.
...
- Scanner `DISC_866F15B7F36E0FD00D03` / `TEST_REVIEW_INTERNAL_NONFINITE_CONVERSION_001`: `fast` at `crates/trust-runtime/tests/stdlib_conv_full.rs`.
...
- Scanner `DISC_90A626CE53C7D57DC5C2` / `TEST_CONFORMANCE_RETAIN_RESTART_002`: `fast` at `conformance/cases/init_reset/cfm_init_reset_retain_warm_cold_002/manifest.toml`.
...
- Scanner `DISC_97845B8CA9F60161D3D6` / `TEST_CONFORMANCE_STRUCT_UPDATE_001`: `fast` at `conformance/cases/structs/cfm_structs_initializer_field_update_001/manifest.toml`.
...
- Scanner `DISC_995DE71B7D37603AE518` / `TEST_CONFORMANCE_ARITHMETIC_CONVERSION_COMPARE_001`: `fast` at `conformance/cases/arithmetic/cfm_arithmetic_conversion_compare_001/manifest.toml`.
...
- Scanner `DISC_9C66247D74AB254260F4` / `TEST_RELEASE_HARDWARE_CLAIM_TRACE_001`: `fast` at `crates/verification-cases/tests/release_evidence_trace_cases.rs`.
...
- Scanner `DISC_9F8BEB8B094DF535B91A` / `TEST_REVIEW_DIDCLOSE_CACHE_RACE_001`: `fast` at `crates/trust-lsp/src/state/mod.rs`.
...
- Scanner `DISC_A775873C89FC94EF5C5A` / `TEST_RELEASE_CONFORMANCE_STATUS_TRACE_001`: `fast` at `crates/verification-cases/tests/release_evidence_trace_cases.rs`.
...
- Scanner `DISC_B2E92857708B1893E579` / `TEST_CONFORMANCE_EDGE_SEQUENCE_001`: `fast` at `conformance/cases/edges/cfm_edges_r_f_trig_sequence_001/manifest.toml`.
- Scanner `DISC_B3D35A2D814EC636D28F` / `TEST_CONFORMANCE_INITIALIZATION_001`: `fast` at `conformance/cases/init_reset/cfm_init_reset_var_initialization_001/manifest.toml`.
...
- Scanner `DISC_C2B1165D150599261D9E` / `TEST_DEV_COMMIT_SCOPE_TRACE_001`: `fast` at `crates/trust-dev/src/commit.rs`.
...
- Scanner `DISC_D17425F1AB882935FEFD` / `TEST_REVIEW_LSP_BARE_CR_RANGE_FORMAT_001`: `fast` at `crates/trust-lsp/src/handlers/tests/formatting_and_navigation.rs`.
...
- Scanner `DISC_D66C206227377C80D856` / `TEST_VSIX_TARGET_IDENTITY_TRACE_001`: `fast` at `crates/verification-cases/tests/release_evidence_trace_cases.rs`.
...
- Scanner `DISC_DEDE357A8451BC63D1D2` / `TEST_REVIEW_PEER_TOPOLOGY_ERROR_RENDER_001`: `fast` at `editors/vscode/src/test/suite/network-canvas.test.ts`.
...
- Scanner `DISC_DF96FF0C090A5F5A2FD9` / `TEST_UI_CONNECTOR_STATUS_TRACE_001`: `fast` at `crates/trust-runtime/tests/protocol_status_trace_cases.rs`.
- Scanner `DISC_E0978319FCFE9AACEA7C` / `TEST_REVIEW_COMMIT_SCOPE_CONTAINMENT_001`: `fast` at `crates/trust-dev/src/commit.rs`.
- Scanner `DISC_E2D6D67D3D4756612F17` / `TEST_CONFORMANCE_ENUM_ASSIGNMENT_001`: `fast` at `conformance/cases/enums/cfm_enums_variant_assignment_001/manifest.toml`.
...
- Scanner `DISC_EAE1A96AA5A558A6CE10` / `TEST_CONFORMANCE_TIMER_TON_001`: `fast` at `conformance/cases/timers/cfm_timers_ton_sequence_001/manifest.toml`.
...
- Scanner `DISC_EF7733E7E189B8A906F5` / `TEST_REVIEW_FIELD_RENAME_CROSS_FILE_001`: `fast` at `crates/trust-ide/tests/ide_features/ide_features_part_02.rs`.
...
- Scanner `DISC_F54F262978837F1C1959` / `TEST_CONFORMANCE_TIMER_TOF_002`: `fast` at `conformance/cases/timers/cfm_timers_tof_sequence_002/manifest.toml`.
...
- Scanner `DISC_F7FB21E5636812BD4C17` / `TEST_DEPENDENCY_EXCEPTION_TRACE_001`: `fast` at `crates/verification-cases/tests/release_evidence_trace_cases.rs`.
- Scanner `DISC_F832A79E9B1062EFBEDA` / `TEST_CONFORMANCE_SCAN_CYCLE_001`: `fast` at `conformance/cases/scan_cycle/cfm_scan_cycle_ordering_visibility_001/manifest.toml`.
...
- Scanner `DISC_FA437CAA77C99B81B753` / `TEST_CONFORMANCE_COMMS_PROJECTION_001`: `fast` at `conformance/cases/comms_determinism/cfm_comms_determinism_connector_projection_001/manifest.toml`.
