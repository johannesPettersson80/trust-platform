...
Date: 2026-07-09; refreshed 2026-07-13 for the specification-source audit
...
- `cargo-mutants 27.0.0` package discovery returned zero candidates for the
  ...
  commit `0dc845f99b305139d05f09d3791e0076e03e2971`.
...
- SHA-256:
  `9a55f3afc4f9a1ce946809df64f7f7c254be05bcedbd86c376b3e32c863f15bc`

The latest 2026-07-13 refresh binds the measured pilot to the clean bounded
STRING/WSTRING implementation checkpoint. The validator source digest and the
generated instruction-stream mutant location changed from line 109 to line 150;
the case IDs, commands, and outcomes remain unchanged. The report was
regenerated by the runner rather than hand-edited.
...
```text
cd "$HOME/projects/trust-platform-string-green-498b84d9"
...
python3 scripts/bytecode_validator_mutation.py \
  ...
  --output-json /tmp/string-bytecode-validator-mutation.json \
  --output-markdown /tmp/string-bytecode-validator-mutation.md
```
