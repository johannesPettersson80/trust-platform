...
Date: 2026-07-09; refreshed 2026-07-16 after the stable-error-model batch
...
- `cargo-mutants 27.0.0` package discovery returned zero candidates for the
  ...
  commit `f305dd45f98bdbbe282985dad4fcbe82c5132fb3`.
...
- SHA-256:
  `88e97c57ed47e698f5c3c8d33611e3d8f0a4cdae0135ee84451bfa10c00713a2`

The latest refresh binds the measured pilot to the clean stable-error-model
checkpoint. Bytecode rejection now preserves its stable machine identifier
through runtime apply; this shard still measures only its two reviewed
instruction-stream and stack-shape bypass mutants. Both remain caught. The JSON
was regenerated by the runner rather than hand-edited.
...
```text
cd "$HOME/projects/trust-platform-stable-error-f305dd45"
