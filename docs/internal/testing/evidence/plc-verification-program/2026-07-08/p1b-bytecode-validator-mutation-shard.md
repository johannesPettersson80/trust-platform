...
Date: 2026-07-09; refreshed 2026-07-12 for Phase 16 execution readiness
...
generated-versus-hand-authored provenance, so the mechanically regenerated
`VM_SEAM_VALID_001` file digest changed. The case IDs, mutant selectors,
commands, and outcomes are unchanged. The report was regenerated by the runner
