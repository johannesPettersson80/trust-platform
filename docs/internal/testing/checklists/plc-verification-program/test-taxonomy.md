...
| `verification_tooling` Gate scripts, xtask, verification metadata/evidence, and agent workflow rules | `scripts/**`, `xtask/**`, `verification/**`, `.github/workflows/**`, `.codex/skills/**`, `AGENTS.md`, PLC verification checklists/evidence | Self-test or known-bad fixture first | Script syntax/unit tests, validator tests, known-good/known-bad fixtures, routing/skill contract tests | Enforcing verification gate; remote-builder proof |
