...
Last verified: 2026-05-01 during the BOARD-04 `v0.24.12` docs/test split validation.
...
- [ ] `ARCHIDX-NEXT-02` After the `v0.24.12` BOARD-04 release gate, use the umbrella checklist to pick the next open architecture-program row. Current next open row is `ARCHPROG-BOARD-08` (`runtime-large-file-split-execution-checklist.md`) because BOARD-05 and BOARD-06 are already closed in the tracked branch.
