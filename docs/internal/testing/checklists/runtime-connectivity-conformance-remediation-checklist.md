...
- [x] `RTCONN-P5-002` Add or update HMI rendering for `ConnectorState`, `ConnectorHealth`, `PointQuality`, and `DiscoveryConfidence`. Evidence: `crates/trust-runtime/src/web/ui/hmi.html`, `crates/trust-runtime/src/web/ui/hmi.js`, `crates/trust-runtime/src/web/ui/modules/hmi-transport.js`, and HMI Playwright screenshot `screenshots/hmi-connector-status-summary.png`.
