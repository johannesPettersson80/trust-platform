...
Status: In progress; Phase 1 VM call-dispatch and register-IR root baselines closed with zero missed/timeout mutants; register-IR interpreter/lowering baselines are next.
