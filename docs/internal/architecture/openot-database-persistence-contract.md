...
| MySQL | canonical text, binary identities, InnoDB transaction/checkpoint | central service, TLS, vendor-native backup | `mysql 28.0.2` with minimal Rust/rustls features; largest new Rust dependency group; feature-scoped | support MySQL 8.4 LTS |
