...
variable named by TOML. truST owns the selected logging schema.
...
schema removal. Readiness requires a successful TLS connection, complete
schema generation 1, and zero lag. During outage the service retries with bounded backoff;
