...
Do not start here if you are only trying to understand project layout; start
with [Libraries](index.md) or [Project Layout](../project-layout.md) first.

## Library Guide

--8<-- "docs/guides/OSCAT_LIBRARY_GUIDE.md"
