...
| TwinCAT discovery reports `0 found` | choose the one TwinCAT flow, confirm **Discovery runs from** and **Where is TwinCAT?**, then use bare Host/IP plus Advanced AMS Net ID if UDP identify is blocked | [Beckhoff ADS](connect/external-systems/ads.md) |
