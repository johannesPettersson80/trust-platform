...
export const t = {
  ...
  blockLogic: v("--trust-block-logic", "#55708c"),
  blockLoop: v("--trust-block-loop", "#607d67"),
  blockMath: v("--trust-block-math", "#60688d"),
  blockVariables: v("--trust-block-variables", "#875f81"),
  blockFunctions: v("--trust-block-functions", "#756286"),
  blockIo: v("--trust-block-io", "#9a764b"),
  blockTimer: v("--trust-block-timer", "#916653"),
  blockCounter: v("--trust-block-counter", "#547c98"),
