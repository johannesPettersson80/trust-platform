  ...
  return [
    {
      ...
      detail: "Use a runtime already running on another computer or controller.",
    ...
    },
    {
      ...
      detail: "Create a managed runtime project here, then select it as the Target and click Start.",
    ...
    },
    {
      ...
      detail: "Install on another computer over SSH.",
