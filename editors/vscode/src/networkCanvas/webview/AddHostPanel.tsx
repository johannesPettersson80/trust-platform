  ...
  return (
    <aside style={PANEL} aria-label="Add a host">
      <div style={{ display: "flex", alignItems: "center", padding: "11px 12px", borderBottom: "1px solid #2a2f3a" }}>
        <div style={{ flex: 1, fontSize: 12, fontWeight: 700, color: "#cfd6e0" }}>Add a host</div>
      ...
      <div style={{ flex: 1, overflow: "auto", padding: 12 }}>
        ...
        <input
          ...
          autoFocus
        />
        <p style={{ color: "#7f8794", fontSize: 10.5, marginTop: 4 }}>
          The host:port (or socket) of the runtime's control endpoint.
        </p>
        <p style={{ color: "#6a7280", fontSize: 10, lineHeight: 1.4, marginTop: 12 }}>
