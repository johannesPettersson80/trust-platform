...
export const COMMUNICATION_PROTOCOLS: readonly CommunicationProtocolDescriptor[] = [
  ...
  },
  {
    id: "mesh",
    title: "Mesh / Zenoh",
    purpose: "Share runtime data with peer, client, or router topology.",
    requirements: ["Role", "Listen/connect endpoints", "Auth token if used"],
    group: "runtime",
  ...
  },
  {
    id: "realtime_t0",
    title: "Realtime T0",
    purpose: "Use same-host deterministic shared-memory exchange.",
    requirements: ["Scheduler", "Priority", "CPU affinity"],
    group: "runtime",
  ...
  },
  {
    ...
    purpose: "Configure fleet/federation policy without pretending it is a live link.",
    requirements: ["Profile", "Transport policy", "WAN write policy"],
    group: "runtime",
  ...
  },
  {
    id: "openot",
    title: "OpenOT",
    purpose: "Publish telemetry and evidence records from runtime variables.",
    requirements: ["Shared-memory path", "Capacity", "Producer source"],
    group: "telemetry",
